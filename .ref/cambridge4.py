...
with open('/home/csl/Documents/google_map_crawler/cambridge_point_forpoi_100m.geojson') as f:
...
def scrape_data(ty):
    ...
    place_set = set()
    file_path = f"cambridge4/{ty}.json"
...
if __name__ == "__main__":
    ...
    "travel+agency", "university", "veterinary+care", "zoo", "night+market", "temple", "drink", "tea+house", "traditional+medicine+shop", "calligraphy+studio",
    "traditional+crafts+market", "clinic", "osteopathic", "martial+arts", "glasses+store", "laboratory", "dormitory", "viewing+platform", "cybercafe",
    "pool+hall", "lottery", "stationery", "toy+stroe", "gardening", "nursery", "community+center", "art+center", "rehabilitation",
    "foundation", "social+welfare", "basketball", "baseball", "barber+shop", "historical+attraction", "cultural+center", "bicycle+rental+station", 
    "college", "junior+high+school", "senior+high+school", "design"
]
